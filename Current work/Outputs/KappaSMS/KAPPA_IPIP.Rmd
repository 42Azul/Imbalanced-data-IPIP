...
train_IPIP <- function( prop.maj, OUTPUT, min_str, maj_str, train.set, test.set, 
                        configuration, prediction, metrics, b, np,  p, mt, TRAIN_METRIC = "KAPPA", SELECT_METRIC = "KAPPA"){
...
train_IPIP_exhaustive <- function( prop.maj, OUTPUT, min_str, maj_str, train.set, test.set, configuration, prediction, metrics, np,  p, TRAIN_METRIC = "KAPPA", SELECT_METRIC = "KAPPA"){
